              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Receive updates about your usage and billing</p>
                      </div>
                      <input
                        type="checkbox"
                        defaultChecked
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="font-medium text-gray-900 dark:text-white">Usage Alerts</label>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Get notified when approaching token limits</p>
                      </div>
                      <input
                        type="checkbox"
                        defaultChecked
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="w-full text-left px-4 py-3 border border-red-300 dark:border-red-600 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20">
                      Delete Account
                    </button>
                  </div>
                </div>
