...
const exportMessageAsPDF = async (message: Message, userMessage?: Message) => {
  try {
    ...
    doc.text('EscapeArtist AI', margin, y);
    y += 20;
    ...
    doc.text('Generated by EscapeArtist AI • Advanced AI Search Engine', margin, y);
  ...
  try {
    ...
    children.push(
      new Paragraph({
        children: [
          new TextRun({
            text: 'EscapeArtist AI Chat Export',
            bold: true,
            size: 32,
            color: '1a56db',
          }),
    ...
    children.push(
      new Paragraph({
        children: [
          new TextRun({
            text: 'Generated by EscapeArtist AI • Advanced AI Search Engine',
            italics: true,
            color: '6B7280',
            size: 16,
          }),
